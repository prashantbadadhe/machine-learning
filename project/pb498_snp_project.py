...
print("Done with reading data ",end="")
...
print("\nPredicted labels will be saved in a file named pb498_predicted_labels")
...
#create a file
f1 = open("pb498_predicted_labels","w+")
